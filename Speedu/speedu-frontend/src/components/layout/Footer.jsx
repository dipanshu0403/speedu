        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:grid-cols-2 lg:grid-cols-3 lg:px-12">
          <div className="space-y-3">
            <div className="inline-flex items-center gap-2 text-lg font-extrabold">
              <span className="grid h-9 w-9 place-items-center rounded-lg bg-gradient-to-br from-emerald-600 to-teal-700 text-white font-black text-xl select-none shadow-md">
                S
              </span>
              Speedu
            </div>
